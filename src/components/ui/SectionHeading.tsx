...
export function SectionHeading({
  ...
  return (
    ...
    >
      <span className="inline-flex items-center gap-3 text-xs uppercase tracking-[0.4em] text-accent">
      ...
      {description && (
        <p
          className={`max-w-2xl text-base sm:text-lg text-ink-dim ${isCenter ? "mx-auto" : ""}`}
        >
          {description}
        </p>
      )}
